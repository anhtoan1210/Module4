...
import com.example.demo.model.TinTucDTO;
import com.example.demo.service.IDanhMucService;
import com.example.demo.service.ITinTucService;
...
public class tinTucController {
    ...
    @GetMapping("")
    public String showList(Model model, @RequestParam(required = false) String name, @RequestParam(required = false) Integer danhMuc,
